...
2. [Fork](https://docs.github.com/en/get-started/quickstart/fork-a-repo) the [Slides repo](https://codeberg.org/activist-org/slides), clone your fork, and configure the remotes:
...
>
> GitHub also has their documentation on how to [Generate a new SSH key](https://docs.codeberg.org/en/authentication/connecting-to-github-with-ssh/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent) 🔑
>
> </p>
> </details>
...
git remote add upstream https://codeberg.org/activist-org/slides.git
```
...
The [issue tracker for Slides](https://codeberg.orgactivist-org/slides/issues) is the preferred channel for [bug reports](#bug-reports), [features requests](#feature-requests) and [submitting pull requests](#pull-requests).

Be sure to check the [`-priority-`](https://codeberg.org/activist-org/slides/labels/-priority-) labels in the [issues](https://codeberg.org/activist-org/slides/issues) for those that are most important, as well as those marked [`good first issue`](https://codeberg.org/activist-org/slides/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) that are tailored for first time contributors.
...
To make the above steps easier, the Slides team asks that contributors report bugs using the [bug report template](https://codeberg.org/activist-org/slides/issues/new?assignees=&labels=bug&template=bug_report.yml), with these issues further being marked with the [`Bug`](https://codeberg.org/activist-org/slides/issues?q=is%3Aopen+is%3Aissue+type%3ABug) type.
...
Feature requests are more than welcome! Please take a moment to find out whether your idea fits with the scope and aims of the project. When making a suggestion, provide as much detail and context as possible, and further make clear the degree to which you would like to contribute in its development. Feature requests are marked with the [`Feature`](https://codeberg.org/activist-org/slides/issues?q=is%3Aopen+is%3Aissue+type%3AFeature) type in the [issues](https://codeberg.org/activist-org/slides/issues).
